...
x-load:	version $(OBJS) $(LIBS) $(LDSCRIPT)
...
version:
		@echo -n "#define X_LOADER_VERSION \""$(ORGANIZATION)" X-Loader " > $(VERSION_FILE); \
		echo -n "$(X_LOADER_VERSION)" >> $(VERSION_FILE); \
		echo -n $(shell $(CONFIG_SHELL) $(TOPDIR)/scripts/setlocalversion \
			 $(TOPDIR)) >> $(VERSION_FILE); \
		echo "\"" >> $(VERSION_FILE)
...
bn_usbboot_config: unconfig
	@./mkconfig $(@:_config=) arm omap4 bn_usbboot
	echo "/* Automatically generated - do not edit */" >./include/config.h; \
	echo "#define CONFIG_USBBOOT" >>./include/config.h; \
	echo "#define CONFIG_IS_OMAP4" >>./include/config.h; \
	echo "#include <configs/bn_usbboot.h>" >>./include/config.h;

bn_usbboot_eraser_config: unconfig
	@./mkconfig $(@:_config=) arm omap4 bn_usbboot
	echo "/* Automatically generated - do not edit */" >./include/config.h; \
	echo "#define CONFIG_USBBOOT" >>./include/config.h; \
	echo "#define CONFIG_USBBOOT_ERASER" >>./include/config.h; \
	echo "#define CONFIG_IS_OMAP4" >>./include/config.h; \
	echo "#include <configs/bn_usbboot.h>" >>./include/config.h;

bn_usbboot_memtest_config: unconfig
	@./mkconfig $(@:_config=) arm omap4 bn_usbboot
	echo "/* Automatically generated - do not edit */" >./include/config.h; \
	echo "#define CONFIG_USBBOOT" >>./include/config.h; \
	echo "#define CONFIG_USBOOT_MEMTEST" >>./include/config.h; \
	echo "#define CONFIG_IS_OMAP4" >>./include/config.h; \
	echo "#include <configs/bn_usbboot.h>" >>./include/config.h;


bn_ovation_config :	unconfig
	@./mkconfig $(@:_config=) arm omap4 bn_ovation
	echo "/* Automatically generated - do not edit */" >./include/config.h; \
	echo "#include <configs/bn_ovation.h>" >>./include/config.h;

bn_hummingbird_config : unconfig
	@./mkconfig $(@:_config=) arm omap4 bn_hummingbird
	echo "/* Automatically generated - do not edit */" >./include/config.h; \
	echo "#include <configs/bn_hummingbird.h>" >>./include/config.h;

bn_acclaim_config :	unconfig
	@./mkconfig $(@:_config=) arm omap4 bn_acclaim
	echo "/* Automatically generated - do not edit */" >./include/config.h;
	echo "#include <configs/bn_acclaim.h>" >>./include/config.h;
...
clobber:	clean
	...
	rm -f include/asm/proc include/asm/arch $(VERSION_FILE)
