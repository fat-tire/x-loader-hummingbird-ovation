...
const struct ddr_regs ddr_regs_elpida4G_400_mhz_2cs = {
	.tim1		= 0x10eb0662,
	.tim2		= 0x20370dd2,
	.tim3		= 0x00b1c33f,
	.phy_ctrl_1	= 0x449FF408,
	.ref_ctrl	= 0x00000618,
	.config_init	= 0x80800eba,
	.config_final	= 0x80801aba,
	.zq_config	= 0xd00b3215,
	.mr1		= 0x83,
	.mr2		= 0x4
};
...
const struct ddr_regs ddr_regs_elpida4G_466_mhz_2cs = {
#ifdef CORE_233MHZ
	.tim1		= 0x130D376B,
	.tim2		= 0x3041105A,
	.tim3		= 0x00D4E3CF,
...
void ddr_init_elpida(void)
	__attribute__((weak, alias("__ddr_init_elpida")));
